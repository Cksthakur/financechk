...
const CITY_NAME = "Kochi"

export const Route = createFileRoute("/tools/home-loan-eligibility-kochi")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer: `In ${CITY_NAME}, with a ₹1 lakh monthly salary, you can get a home loan of approximately ₹50-60 lakh. ${CITY_NAME} has relatively affordable property prices in Kerala. A decent 2BHK in Edappally costs ₹30-45 lakh.`,
  },
  {
    question: "Which banks offer the best home loan rates in Kochi?",
    answer:
      "In Kochi, SBI, HDFC, ICICI, Axis Bank, and Federal Bank offer competitive home loan rates (8.25-8.75%). Federal Bank has special schemes for Kerala residents.",
  },
  {
    question: "What is the average property price in Kochi?",
    answer:
      "Average property prices in Kochi range from ₹5,000-₹10,000 per sq ft depending on location. Marine Drive, Kakkanad are premium. A decent 2BHK costs ₹25-45 lakh.",
  },
]
        ...
        <div className="rounded-2xl bg-muted/50 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <p className="text-sm">1BHK in Kakkanad</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">2BHK in Edappally</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">3BHK in Marine Drive</p>
            </div>
          </div>
        </div>
