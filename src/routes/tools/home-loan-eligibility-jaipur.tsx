...
const CITY_NAME = "Jaipur"

export const Route = createFileRoute("/tools/home-loan-eligibility-jaipur")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer: `In ${CITY_NAME}, with a ₹1 lakh monthly salary, you can get a home loan of approximately ₹50-60 lakh. ${CITY_NAME} has affordable property prices compared to metros. A decent 2BHK in good areas costs ₹25-40 lakh.`,
  },
  {
    question: "Which banks offer the best home loan rates in Jaipur?",
    answer:
      "In Jaipur, SBI, HDFC, ICICI, Axis Bank, and Bank of Baroda offer competitive home loan rates (8.25-8.75%). Local banks like Rajasthan Maru Gramin Bank also offer good rates.",
  },
  {
    question: "What is the average property price in Jaipur?",
    answer:
      "Average property prices in Jaipur range from ₹3,500-₹8,000 per sq ft depending on location. Malviya Nagar, MI Road areas are premium. A decent 2BHK costs ₹20-40 lakh.",
  },
]
        ...
        <div className="rounded-2xl bg-muted/50 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <p className="text-sm">1BHK in Vaishali Nagar</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">2BHK in Mansarovar</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">3BHK in C-Scheme</p>
            </div>
          </div>
        </div>
