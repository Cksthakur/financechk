...
const INCOME_LEVEL = "₹4 Lakh"
const INCOME_VALUE = 400000

export const Route = createFileRoute("/tools/income-tax-calculator-4-lakh")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is ₹0! With the standard deduction of ₹75,000, your taxable income becomes ₹3,25,000, which falls entirely in the nil tax bracket (₹0-₹4 lakh). You pay ZERO tax.",
  },
  {
    question: `Is ${INCOME_LEVEL} income tax-free in new regime?`,
    answer:
      "Yes, completely! With the ₹75,000 standard deduction, your taxable income is ₹3,25,000 which is below the ₹4 lakh nil bracket. You pay ZERO tax under the New Regime.",
  },
  {
    question: "Which tax regime is better for this income level?",
    answer:
      "For ₹4 lakh income, the New Tax Regime is better. The Old Regime with standard deduction would have higher taxable income, resulting in some tax. New Regime gives you ₹0 tax.",
  },
]

const howToSteps = [
  `Your gross salary of ₹4,00,000 is pre-filled. Adjust if needed.`,
  "Under New Regime: Taxable = ₹4L - ₹75k = ₹3.25L = ₹0 Tax (below ₹4L nil bracket)",
  "Under Old Regime: Taxable = ₹4L - ₹50k = ₹3.5L = ~₹10,000 tax",
  "New Regime saves approximately ₹10,000 in taxes.",
]
