...
export const Route = createFileRoute("/tools/home-loan-eligibility-bangalore")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer: `In ${CITY_NAME}, with a ₹1 lakh monthly salary, you can get a home loan of approximately ₹40-50 lakh. ${CITY_NAME} has high property prices, so most buyers need loans of ₹50 lakh to ₹1 crore for a decent 2BHK.`,
  },
  {
    question: "Which banks offer the best home loan rates in Bangalore?",
    answer:
      "In Bangalore, SBI, HDFC, ICICI, Axis Bank, and Bank of Baroda offer competitive home loan rates (8.25-8.75%). Government employees can get preferential rates. Bangalore has many top banks with good customer service.",
  },
  {
    question: "What is the average property price in Bangalore?",
    answer:
      "Average property prices in Bangalore range from ₹5,000-₹15,000 per sq ft depending on location. Whitefield, Sarjapur, and North Bangalore areas are popular. A 2BHK in good areas costs ₹80 lakh to ₹1.5 crore.",
  },
]
        ...
        <div className="rounded-2xl bg-muted/50 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <p className="text-sm">1BHK in outskirts</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">2BHK in good area</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">Premium</p>
              <p className="text-xl font-bold">
                {formatCompactCurrency(result.maxLoanAmount * 1.2)}
              </p>
              <p className="text-sm">3BHK in prime location</p>
            </div>
          </div>
        </div>
