...
export const Route = createFileRoute("/tools/home-loan-eligibility-mumbai")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer: `In ${CITY_NAME}, with a ₹1 lakh monthly salary, you can get a home loan of approximately ₹35-45 lakh. ${CITY_NAME} has the highest property prices in India, so most buyers need loans of ₹50 lakh to ₹2 crore for a decent 1BHK in suburban areas.`,
  },
  {
    question: "Which banks offer the best home loan rates in Mumbai?",
    answer:
      "In Mumbai, SBI, HDFC, ICICI, Axis Bank, and Bank of Baroda offer competitive home loan rates (8.25-8.75%). Mumbai has the highest concentration of bank branches. Government employees get preferential rates.",
  },
  {
    question: "What is the average property price in Mumbai?",
    answer:
      "Average property prices in Mumbai range from ₹15,000-₹30,000 per sq ft depending on location. South Mumbai can go above ₹50,000 sq ft. A decent 1BHK in suburbs costs ₹80 lakh to ₹1.5 crore.",
  },
]
        ...
        <div className="rounded-2xl bg-muted/50 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <p className="text-sm">1BHK in far suburbs</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">1BHK in suburbs</p>
            </div>
            <div className="space-y-2">
