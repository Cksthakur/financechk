...
const INCOME_LEVEL = "₹6 Lakh"
const INCOME_VALUE = 600000

export const Route = createFileRoute("/tools/income-tax-calculator-6-lakh")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is approximately ₹6,500. After the standard deduction of ₹75,000, your taxable income is ₹5,25,000. Tax is only on the amount above ₹4 lakh: 5% of ₹1.25 lakh = ₹6,250 + ₹250 cess.",
  },
  {
    question: `Is ${INCOME_LEVEL} income tax-free in new regime?`,
    answer:
      "No, not completely. While the popular myth says ₹7.75 lakh is tax-free, that's because you can claim deductions. At exactly ₹6 lakh with no deductions, you pay about ₹6,500 tax. The zero-tax limit without deductions is ₹4 lakh.",
  },
  {
    question: "Which tax regime is better for ₹6 lakh income?",
    answer:
      "For ₹6 lakh income without significant deductions, the New Tax Regime is better. With ₹2 lakh of deductions (80C + 80D + NPS), both regimes give similar results. Without deductions, New Regime saves approximately ₹8,000.",
  },
]

const howToSteps = [
  `Your gross salary of ₹6,00,000 is pre-filled. Adjust if needed.`,
  "Under New Regime: Taxable = ₹6L - ₹75k = ₹5.25L = ~₹6,500 tax (5% on ₹1.25L above ₹4L)",
  "Under Old Regime: Taxable = ₹6L - ₹50k = ₹5.5L = ~₹14,500 tax",
  "New Regime saves approximately ₹8,000 in taxes.",
]
