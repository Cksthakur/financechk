...
export const Route = createFileRoute("/tools/income-tax-calculator-50-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹50 Lakh - Old vs New Regime FY 2025-26",
      description:
        "Free online income tax calculator for ₹50 lakh annual salary. Compare old vs new tax regime for FY 2025-26 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-50-lakh",
    }),
  component: IncomeTax50Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹50 lakh income?",
    answer:
      "Under the New Tax Regime FY 2025-26, your tax is approximately ₹6,62,000. With the standard deduction of ₹75,000, your taxable income becomes ₹49,25,000. The tax includes 30% of the amount above ₹24 lakh plus lower slabs.",
  },
  {
    question: "Which tax regime is better for ₹50 lakh salary?",
    answer:
      "For ₹50 lakh income, the New Tax Regime is significantly better. Even with max deductions, the Old Regime cannot match the New Regime benefits. Expect to save ₹1.5+ lakh with the New Regime.",
  },
  {
    question: "What deductions can I claim on ₹50 lakh salary?",
    answer:
...
const howToSteps = [
  "Your gross salary of ₹50,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable = ₹50,00,000 - ₹75,000 = ₹49,25,000 → ~₹6,62,000 tax",
  "Under Old Regime: With ₹5,00,000 deductions, taxable = ₹45,00,000 → ~₹6,50,000 tax",
  "New Regime is typically better. Calculate to confirm your savings.",
]

function IncomeTax50Lakh() {
  const [annualSalary, setAnnualSalary] = useState(5000000)
  const [basicSalary, setBasicSalary] = useState(2500000)
  const [hra, setHra] = useState(1000000)
  const [rentPaid, setRentPaid] = useState(1200000)
  ...
  return (
    <ToolLayout
      breadcrumbs={[
        ...
        { label: "₹50 Lakh Income Tax Calculator" },
      ]}
    >
      <div className="mx-auto max-w-5xl space-y-6 px-0 py-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
            Income Tax Calculator for ₹50 Lakh Salary
          </h1>
