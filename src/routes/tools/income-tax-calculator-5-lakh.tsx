...
export const Route = createFileRoute("/tools/income-tax-calculator-5-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹5 Lakh - Old vs New Regime FY 2026-27",
      description:
        "Free online income tax calculator for ₹5 lakh annual salary. Compare old vs new tax regime for FY 2026-27 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-5-lakh",
    }),
  component: IncomeTax5Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹5 lakh income?",
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is ₹0! With the standard deduction of ₹75,000, your taxable income becomes ₹4,25,000, which falls in the nil tax bracket (₹0-₹4 lakh). Additionally, the Section 87A rebate of ₹12,500 ensures zero tax.",
  },
  {
    question: "Which tax regime is better for ₹5 lakh income?",
    answer:
      "For ₹5 lakh income, the New Tax Regime is significantly better. Your tax under the Old Regime would be around ₹15,600 with standard deductions, while the New Regime gives you ₹0 tax. The difference is ₹15,600 in your pocket.",
  },
  {
    question: "Can I claim deductions on ₹5 lakh salary?",
    answer:
      "Yes, you can still claim deductions under the Old Tax Regime even with ₹5 lakh income. Popular deductions include Section 80C (EPF, PPF, LIC - up to ₹1.5 lakh), Section 80D (Health Insurance up to ₹25,000), and NPS contribution (up to ₹50,000).",
  },
]

const howToSteps = [
  "Your gross salary of ₹5,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable income = ₹5,00,000 - ₹75,000 (Standard Deduction) = ₹4,25,000 = ₹0 Tax",
  "Under Old Regime: With ₹1,50,000 deductions, taxable = ₹3,50,000 = ~₹15,600 tax",
  "Compare both regimes to see which saves you more money.",
]

function IncomeTax5Lakh() {
  const [annualSalary, setAnnualSalary] = useState(500000)
  const [basicSalary, setBasicSalary] = useState(250000)
  ...
  return (
    <ToolLayout
      breadcrumbs={[
        ...
        { label: "₹5 Lakh Income Tax Calculator" },
      ]}
    >
      <div className="mx-auto max-w-5xl space-y-6 px-0 py-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
            Income Tax Calculator for ₹5 Lakh Salary
          </h1>
