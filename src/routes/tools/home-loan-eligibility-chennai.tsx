...
export const Route = createFileRoute("/tools/home-loan-eligibility-chennai")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer: `In ${CITY_NAME}, with a ₹1 lakh monthly salary, you can get a home loan of approximately ₹40-50 lakh. ${CITY_NAME} has affordable property prices compared to other metro cities. A decent 2BHK in good areas costs ₹50-80 lakh.`,
  },
  {
    question: "Which banks offer the best home loan rates in Chennai?",
    answer:
      "In Chennai, SBI, HDFC, ICICI, Axis Bank, and Indian Bank offer competitive home loan rates (8.25-8.75%). State Bank of India has special schemes for TN government employees.",
  },
  {
    question: "What is the average property price in Chennai?",
    answer:
      "Average property prices in Chennai range from ₹5,000-₹12,000 per sq ft depending on location. Areas like OMR, ECR, and Anna Nagar are popular. A 2BHK costs ₹50 lakh to ₹1 crore.",
  },
]
