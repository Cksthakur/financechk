...
export const Route = createFileRoute("/tools/income-tax-calculator-9-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹9 Lakh - Old vs New Regime FY 2026-27",
      description:
        "Free online income tax calculator for ₹9 lakh annual salary. Compare old vs new tax regime for FY 2026-27 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-9-lakh",
    }),
  component: IncomeTax9Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹9 lakh income?",
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is approximately ₹45,000. With the standard deduction of ₹75,000, your taxable income becomes ₹8,25,000. After applying the tax slabs, you pay around ₹30,000 + 10% of (₹8,25,000 - ₹4,00,000) = ₹30,000 + ₹42,500 = ₹72,500, minus the Section 87A rebate.",
  },
  {
    question: "Which tax regime is better for ₹9 lakh salary?",
    answer:
      "For ₹9 lakh income, the New Tax Regime is generally better if you do not have significant deductions. With ₹1.5 lakh in Section 80C deductions plus HRA, the Old Regime might save you about ₹10,000-15,000. Calculate both to decide.",
  },
  {
    question: "What deductions can I claim on ₹9 lakh salary?",
    answer:
...
const howToSteps = [
  "Your gross salary of ₹9,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable income = ₹9,00,000 - ₹75,000 = ₹8,25,000 → ~₹45,000 tax",
  "Under Old Regime: With ₹1,50,000 deductions, taxable = ₹7,50,000 → ~₹40,000 tax",
  "Compare both regimes to see which saves you more money.",
]

function IncomeTax9Lakh() {
  const [annualSalary, setAnnualSalary] = useState(900000)
  const [basicSalary, setBasicSalary] = useState(450000)
  ...
  return (
    <ToolLayout
      breadcrumbs={[
        ...
        { label: "₹9 Lakh Income Tax Calculator" },
      ]}
    >
      <div className="mx-auto max-w-5xl space-y-6 px-0 py-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
            Income Tax Calculator for ₹9 Lakh Salary
          </h1>
