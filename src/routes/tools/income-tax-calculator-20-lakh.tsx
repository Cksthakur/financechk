...
export const Route = createFileRoute("/tools/income-tax-calculator-20-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹20 Lakh - Old vs New Regime FY 2026-27",
      description:
        "Free online income tax calculator for ₹20 lakh annual salary. Compare old vs new tax regime for FY 2026-27 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-20-lakh",
    }),
  component: IncomeTax20Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹20 lakh income?",
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is approximately ₹2,12,000. With the standard deduction of ₹75,000, your taxable income becomes ₹19,25,000. The tax includes ₹30,000 (5%) + ₹90,000 (15%) + ₹65,000 (20%) + ₹7,500 (cess).",
  },
  {
    question: "Which tax regime is better for ₹20 lakh salary?",
    answer:
      "For ₹20 lakh income, the New Tax Regime is generally better unless you have very high deductions (₹4+ lakh). With standard deductions (80C, 80D, NPS, HRA, home loan), the Old Regime might save you ₹30,000-50,000.",
  },
  {
    question: "What deductions can I claim on ₹20 lakh salary?",
    answer:
      "Popular deductions include Section 80C (EPF, PPF, LIC - up to ₹1.5 lakh), Section 80D (Health Insurance up to ₹50,000 for family), NPS contribution (up to ₹50,000), HRA if you pay rent, Home Loan Interest (Section 24b up to ₹2 lakh), and Charity donations (80G).",
  },
]

const howToSteps = [
  "Your gross salary of ₹20,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable = ₹20,00,000 - ₹75,000 = ₹19,25,000 → ~₹2,12,000 tax",
  "Under Old Regime: With ₹3,50,000 deductions, taxable = ₹16,50,000 → ~₹2,00,000 tax",
  "Compare both regimes to see which saves you more money.",
]

function IncomeTax20Lakh() {
  const [annualSalary, setAnnualSalary] = useState(2000000)
  const [basicSalary, setBasicSalary] = useState(1000000)
  const [hra, setHra] = useState(400000)
  const [rentPaid, setRentPaid] = useState(480000)
  ...
  const [homeLoanInterest, setHomeLoanInterest] = useState(100000)
  ...
  return (
    <ToolLayout
      breadcrumbs={[
        ...
        { label: "₹20 Lakh Income Tax Calculator" },
      ]}
    >
      <div className="mx-auto max-w-5xl space-y-6 px-0 py-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
            Income Tax Calculator for ₹20 Lakh Salary
          </h1>
