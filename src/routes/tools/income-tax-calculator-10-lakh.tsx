...
export const Route = createFileRoute("/tools/income-tax-calculator-10-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹10 Lakh - Old vs New Regime FY 2026-27",
      description:
        "Free online income tax calculator for ₹10 lakh annual salary. Compare old vs new tax regime for FY 2026-27 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-10-lakh",
    }),
  component: IncomeTax10Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹10 lakh income?",
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is approximately ₹70,000. With the standard deduction of ₹75,000, your taxable income becomes ₹9,25,000. After applying tax slabs, you pay around ₹30,000 + 15% of (₹9,25,000 - ₹6,00,000) minus any Section 87A rebate.",
  },
  {
    question: "Which tax regime is better for ₹10 lakh salary?",
    answer:
      "For ₹10 lakh income, the New Tax Regime is generally better unless you have significant deductions. With ₹2.5 lakh+ in deductions (80C, 80D, NPS, HRA, home loan interest), the Old Regime might save you ₹20,000-30,000. Calculate both to decide.",
  },
  {
    question: "What deductions can I claim on ₹10 lakh salary?",
    answer:
      "Popular deductions include Section 80C (EPF, PPF, LIC - up to ₹1.5 lakh), Section 80D (Health Insurance up to ₹25,000), NPS contribution (up to ₹50,000), HRA if you pay rent, and Home Loan Interest (Section 24b up to ₹2 lakh).",
  },
]

const howToSteps = [
  "Your gross salary of ₹10,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable income = ₹10,00,000 - ₹75,000 = ₹9,25,000 → ~₹70,000 tax",
  "Under Old Regime: With ₹2,50,000 deductions, taxable = ₹7,50,000 → ~₹60,000 tax",
  "Compare both regimes to see which saves you more money.",
]

function IncomeTax10Lakh() {
  ...
  return (
    <ToolLayout
      breadcrumbs={[
        ...
        { label: "₹10 Lakh Income Tax Calculator" },
      ]}
    >
      <div className="mx-auto max-w-5xl space-y-6 px-0 py-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
            Income Tax Calculator for ₹10 Lakh Salary
          </h1>
