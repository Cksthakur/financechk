...
export const Route = createFileRoute("/tools/income-tax-calculator-15-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹15 Lakh - Old vs New Regime FY 2026-27",
      description:
        "Free online income tax calculator for ₹15 lakh annual salary. Compare old vs new tax regime for FY 2026-27 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-15-lakh",
    }),
  component: IncomeTax15Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹15 lakh income?",
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is approximately ₹1,25,000. With the standard deduction of ₹75,000, your taxable income becomes ₹14,25,000. After applying tax slabs (₹30,000 + 15% of ₹6L + 20% of ₹2.25L), you pay around ₹1,25,000.",
  },
  {
    question: "Which tax regime is better for ₹15 lakh salary?",
    answer:
      "For ₹15 lakh income, the difference is marginal. The New Regime typically saves you ₹10,000-20,000 unless you have substantial deductions (₹3+ lakh). With home loan interest, NPS, and 80C, the Old Regime might be better.",
  },
  {
    question: "What deductions can I claim on ₹15 lakh salary?",
    answer:
      "Popular deductions include Section 80C (EPF, PPF, LIC - up to ₹1.5 lakh), Section 80D (Health Insurance up to ₹25,000), NPS contribution (up to ₹50,000), HRA if you pay rent, Home Loan Interest (Section 24b up to ₹2 lakh), and Education Loan interest.",
  },
]

const howToSteps = [
  "Your gross salary of ₹15,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable = ₹15,00,000 - ₹75,000 = ₹14,25,000 → ~₹1,25,000 tax",
  "Under Old Regime: With ₹3,00,000 deductions, taxable = ₹12,00,000 → ~₹1,15,000 tax",
  "Compare both regimes to see which saves you more money.",
]

function IncomeTax15Lakh() {
  ...
  const [rentPaid, setRentPaid] = useState(360000)
  ...
  return (
    <ToolLayout
      breadcrumbs={[
        ...
        { label: "₹15 Lakh Income Tax Calculator" },
      ]}
    >
      <div className="mx-auto max-w-5xl space-y-6 px-0 py-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
            Income Tax Calculator for ₹15 Lakh Salary
          </h1>
