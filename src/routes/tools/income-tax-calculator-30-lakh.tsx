...
export const Route = createFileRoute("/tools/income-tax-calculator-30-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹30 Lakh - Old vs New Regime FY 2025-26",
      description:
        "Free online income tax calculator for ₹30 lakh annual salary. Compare old vs new tax regime for FY 2025-26 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-30-lakh",
    }),
  component: IncomeTax30Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹30 lakh income?",
    answer:
      "Under the New Tax Regime FY 2025-26, your tax is approximately ₹3,62,000. With the standard deduction of ₹75,000, your taxable income becomes ₹29,25,000. The tax includes ₹30,000 + ₹90,000 + ₹1,30,000 + ₹65,000 + ₹18,500 (cess).",
  },
  {
    question: "Which tax regime is better for ₹30 lakh salary?",
    answer:
      "For ₹30 lakh income, the New Tax Regime is better unless you have very high deductions (₹6+ lakh). The difference is typically ₹50,000-80,000 in favor of the New Regime due to lower tax slabs.",
  },
  {
    question: "What deductions can I claim on ₹30 lakh salary?",
    answer:
...
const howToSteps = [
  "Your gross salary of ₹30,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable = ₹30,00,000 - ₹75,000 = ₹29,25,000 → ~₹3,62,000 tax",
  "Under Old Regime: With ₹4,50,000 deductions, taxable = ₹25,50,000 → ~₹3,50,000 tax",
  "Compare both regimes to see which saves you more money.",
]

function IncomeTax30Lakh() {
  const [annualSalary, setAnnualSalary] = useState(3000000)
  const [basicSalary, setBasicSalary] = useState(1500000)
  const [hra, setHra] = useState(600000)
  const [rentPaid, setRentPaid] = useState(720000)
  ...
  return (
    <ToolLayout
      breadcrumbs={[
        ...
        { label: "₹30 Lakh Income Tax Calculator" },
      ]}
    >
      <div className="mx-auto max-w-5xl space-y-6 px-0 py-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
            Income Tax Calculator for ₹30 Lakh Salary
          </h1>
