...
export const Route = createFileRoute("/tools/home-loan-eligibility-lucknow")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer: `In ${CITY_NAME}, with a ₹1 lakh monthly salary, you can get a home loan of approximately ₹50-60 lakh. ${CITY_NAME} has affordable property prices. A decent 2BHK in Gomti Nagar costs ₹30-50 lakh.`,
  },
  {
    question: "Which banks offer the best home loan rates in Lucknow?",
    answer:
      "In Lucknow, SBI, HDFC, ICICI, Axis Bank, and Bank of Baroda offer competitive home loan rates (8.25-8.75%). SBI and PNB have strong presence with good rates.",
  },
  {
    question: "What is the average property price in Lucknow?",
    answer:
      "Average property prices in Lucknow range from ₹4,000-₹9,000 per sq ft depending on location. Gomti Nagar, Mahanagar are premium areas. A decent 2BHK costs ₹25-50 lakh.",
  },
]
        ...
        <div className="rounded-2xl bg-muted/50 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <p className="text-sm">2BHK in Alambagh</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">2BHK in Gomti Nagar</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">3BHK in Golf City</p>
            </div>
          </div>
        </div>
