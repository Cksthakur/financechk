...
export const Route = createFileRoute("/tools/home-loan-eligibility-hyderabad")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer: `In ${CITY_NAME}, with a ₹1 lakh monthly salary, you can get a home loan of approximately ₹40-50 lakh. ${CITY_NAME} has growing property prices, so most buyers need loans of ₹40-80 lakh for a decent 2BHK.`,
  },
  {
    question: "Which banks offer the best home loan rates in Hyderabad?",
    answer:
      "In Hyderabad, SBI, HDFC, ICICI, Axis Bank, and Telangana State Cooperative Bank offer competitive home loan rates (8.25-8.75%). Many banks have special schemes for IT professionals in Cyberabad.",
  },
  {
    question: "What is the average property price in Hyderabad?",
    answer:
      "Average property prices in Hyderabad range from ₹4,500-₹12,000 per sq ft depending on location. Gachibowli, Kondapur, and HITEC City areas are popular for IT professionals. A 2BHK costs ₹50 lakh to ₹1 crore.",
  },
]
