...
export const Route = createFileRoute("/tools/income-tax-calculator-1-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹1 Lakh - Old vs New Regime FY 2026-27",
      description:
        "Free online income tax calculator for ₹1 lakh annual salary. Compare old vs new tax regime for FY 2026-27 with accurate India tax slabs. Zero tax for income up to ₹4 lakh.",
      path: "/tools/income-tax-calculator-1-lakh",
    }),
  component: IncomeTax1Lakh,
})

const faqs = [
  {
    question: "Do I need to pay tax on ₹1 lakh income?",
    answer:
      "No, you do not need to pay any tax on ₹1 lakh annual income. Under both old and new tax regimes for FY 2026-27, the taxable income falls well within the nil tax bracket. With the standard deduction, your tax is ₹0.",
  },
  {
    question: "Which tax regime is better for ₹1 lakh income?",
    answer:
      "Both regimes result in zero tax for ₹1 lakh income. There is no difference in your tax liability. You can choose either regime - the old regime offers more deductions if you want to claim them for future higher incomes.",
  },
  {
    question: "Do I need to file ITR for ₹1 lakh salary?",
    answer:
      "If your only income is ₹1 lakh per year from salary, you are not required to file an ITR as your total income is below the basic exemption limit of ₹2.5 lakh (₹3 lakh for senior citizens). However, filing can be beneficial for maintaining a tax record.",
  },
]

const howToSteps = [
  "Your gross salary of ₹1,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable = ₹1,00,000 - ₹75,000 (Standard Deduction) = ₹25,000 = ₹0 Tax",
  "Under Old Regime: Taxable = ₹1,00,000 - ₹50,000 (Standard Deduction) = ₹50,000 = ₹0 Tax",
  "Both regimes give you zero tax. No action needed!",
]

function IncomeTax1Lakh() {
