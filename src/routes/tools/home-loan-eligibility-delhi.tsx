...
export const Route = createFileRoute("/tools/home-loan-eligibility-delhi")({
  head: () =>
    generateSeoMeta({
...
const faqs = [
  {
    ...
    answer: `In ${CITY_NAME}, with a ₹1 lakh monthly salary, you can get a home loan of approximately ₹40-50 lakh. ${CITY_NAME} has high property prices but more affordable than Mumbai. A decent 2BHK in Dwarka, Rohini, or Noida costs ₹40-70 lakh.`,
  },
  {
    question: "Which banks offer the best home loan rates in Delhi?",
    answer:
      "In Delhi-NCR, SBI, HDFC, ICICI, Axis Bank, and Bank of Baroda offer competitive home loan rates (8.25-8.75%). Government employees get preferential rates through SBI.",
  },
  {
    question: "What is the average property price in Delhi?",
    answer:
      "Average property prices in Delhi range from ₹8,000-₹18,000 per sq ft depending on location. South Delhi can go above ₹25,000 sq ft. A decent 2BHK in good areas costs ₹50 lakh to ₹1 crore.",
  },
]
        ...
        <div className="rounded-2xl bg-muted/50 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm">2BHK in suburbs</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm">3BHK in good area</p>
            </div>
          </div>
        </div>
