...
export const Route = createFileRoute("/tools/income-tax-calculator-25-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹25 Lakh - Old vs New Regime FY 2026-27",
      description:
        "Free online income tax calculator for ₹25 lakh annual salary. Compare old vs new tax regime for FY 2026-27 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-25-lakh",
    }),
  component: IncomeTax25Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹25 lakh income?",
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is approximately ₹2,87,000. With the standard deduction of ₹75,000, your taxable income becomes ₹24,25,000. The tax includes ₹30,000 + ₹90,000 + ₹1,30,000 + ₹13,000 (cess).",
  },
  {
    question: "Which tax regime is better for ₹25 lakh salary?",
    answer:
      "For ₹25 lakh income, the New Tax Regime is generally better unless you have substantial deductions (₹5+ lakh). With home loan interest, NPS, 80C, and HRA, the difference is around ₹40,000-60,000 in favor of the New Regime.",
  },
  {
    question: "What deductions can I claim on ₹25 lakh salary?",
    answer:
      "Popular deductions include Section 80C (EPF, PPF, LIC - up to ₹1.5 lakh), Section 80D (Health Insurance up to ₹50,000), NPS contribution (up to ₹50,000), HRA if you pay rent, Home Loan Interest (Section 24b up to ₹2 lakh), and Charity donations (80G).",
  },
]

const howToSteps = [
  "Your gross salary of ₹25,00,000 is pre-filled. Adjust if needed.",
  "Under New Regime: Taxable = ₹25,00,000 - ₹75,000 = ₹24,25,000 → ~₹2,87,000 tax",
  "Under Old Regime: With ₹4,00,000 deductions, taxable = ₹21,00,000 → ~₹2,75,000 tax",
  "Compare both regimes to see which saves you more money.",
]

function IncomeTax25Lakh() {
  const [annualSalary, setAnnualSalary] = useState(2500000)
  const [basicSalary, setBasicSalary] = useState(1250000)
  const [hra, setHra] = useState(500000)
  const [rentPaid, setRentPaid] = useState(600000)
  ...
  return (
    <ToolLayout
      breadcrumbs={[
        ...
        { label: "₹25 Lakh Income Tax Calculator" },
      ]}
    >
      <div className="mx-auto max-w-5xl space-y-6 px-0 py-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
            Income Tax Calculator for ₹25 Lakh Salary
          </h1>
