...
export const Route = createFileRoute("/tools/income-tax-calculator-7-lakh")({
  head: () =>
    generateSeoMeta({
      title: "Income Tax Calculator ₹7 Lakh - Old vs New Regime FY 2026-27",
      description:
        "Free online income tax calculator for ₹7 lakh annual salary. Compare old vs new tax regime for FY 2026-27 with accurate India tax slabs and deductions.",
      path: "/tools/income-tax-calculator-7-lakh",
    }),
  component: IncomeTax7Lakh,
})

const faqs = [
  {
    question: "How much tax do I pay on ₹7 lakh income?",
    answer:
      "Under the New Tax Regime FY 2026-27, your tax is approximately ₹18,000. After the standard deduction of ₹75,000, your taxable income is ₹6,25,000. The tax on first ₹4 lakh is nil, next ₹2.25 lakh at 5% = ₹11,250, plus 4% cess.",
  },
  {
    question: "Is ₹7 lakh income tax-free in new regime?",
    answer:
      "Not completely. While the popular myth says ₹7.75 lakh is tax-free, that's for those with exactly ₹7 lakh income. At ₹7 lakh, you pay about ₹18,000 tax. The zero-tax limit is ₹7,75,000 (₹7 lakh + ₹75,000 standard deduction).",
  },
  {
    question: "Which tax regime is better for ₹7 lakh income?",
    answer:
      "For ₹7 lakh income without significant deductions, the New Tax Regime is better. With ₹2.5 lakh of valid deductions (80C, 80D, NPS), both regimes give similar results. Without deductions, New Regime saves approximately ₹12,000.",
  },
]

const howToSteps = [
  "Your gross salary of ₹7,00,000 is pre-filled for quick calculation.",
  "The New Regime automatically applies the ₹75,000 standard deduction.",
  "Add your deductions (80C, 80D, NPS, home loan interest) for Old Regime comparison.",
  "See instant comparison showing which regime saves you more money.",
]

function IncomeTax7Lakh() {
  const [annualSalary, setAnnualSalary] = useState(700000)
  const [basicSalary, setBasicSalary] = useState(350000)
